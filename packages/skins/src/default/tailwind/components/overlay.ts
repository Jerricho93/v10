...
export const overlay = cn(
  ...
  // Default: hidden
  'opacity-0',
  '[background-image:linear-gradient(to_bottom,oklch(0_0_0/0.3),oklch(0_0_0/0.15),oklch(0_0_0/0)),linear-gradient(to_top,oklch(0_0_0/0.5),oklch(0_0_0/0.3)_25%,oklch(0_0_0/0))]',
